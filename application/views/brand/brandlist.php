...
<div class="page-btn">
<a href="<?php echo base_url();?>brand/addbrand" class="btn btn-added"><img src="<?php echo base_url();?>assets/img/icons/plus.svg" class="me-2" alt="img">Add Brand</a>
</div>
</div>
...
<script type="text/javascript">
    $(document).ready(function(){
        var dataTable = $('#listOfEntries').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url('brand/fetch_records'); ?>",  
                type:"POST"  
           },  
           "columnDefs":[  
                {  
     ...
     function remove_record(id)
     {
          ...
          console.log(result);
            if (result.value) {
                 ...
                 $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('brand/removebrand'); ?>",
                      data: {'id':id,},
