...
<div class="page-btn">
<a href="<?php echo base_url();?>subcategory/addsubcategory" class="btn btn-added"><img src="<?php echo base_url();?>assets/img/icons/plus.svg" class="me-2" alt="img"> Add Sub Category</a>
</div>
</div>
...
<script type="text/javascript">
    $(document).ready(function(){
        var dataTable = $('#listOfEntries').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url('subcategory/fetch_records'); ?>",  
                type:"POST"  
           },  
           "columnDefs":[  
                {  
     ...
     function remove_record(id)
     {
          ...
          console.log(result);
            if (result.value) {
                 ...
                 $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('subcategory/removesub_category'); ?>",
                      data: {'id':id,},
