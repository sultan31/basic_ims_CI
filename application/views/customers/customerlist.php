...
<div class="page-btn">
<a href="<?php echo base_url();?>customers/addcustomer" class="btn btn-added">
<img src="<?php echo base_url();?>assets/img/icons/plus.svg" class="me-1" alt="img">Add Customer
</a>
</div>
</div>
...
<script type="text/javascript">
    $(document).ready(function(){
        var dataTable = $('#listOfEntries').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url('customers/fetch_records'); ?>",  
                type:"POST"  
           },  
           "columnDefs":[  
                {  
